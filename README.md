...
Imported raw dataset from India Data Portal, Cleaned and transformed data (handled missing values, formatting issues), Created calculated columns and key performance metrics, Built Pivot Tables for district-level comparison, Designed Report/visualizations for insights
